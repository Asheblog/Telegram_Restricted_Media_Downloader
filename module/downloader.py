...
class TelegramRestrictedMediaDownloader(TrmdCompositionRoot, WebOperationsMixin, BotHostMixin):
    ...
    async def forward_messages_with_flood_retry(self, *args, **kwargs):
        return await self._ensure_live_transfer().forward_messages_with_flood_retry(*args, **kwargs)
    ...
    async def cancel_listen(self, *args, **kwargs):
        return await self._ensure_live_transfer().cancel_listen(*args, **kwargs)

    async def on_listen(self, *args, **kwargs):
        return await self._ensure_live_transfer().on_listen(*args, **kwargs)

    async def listen_download(self, *args, **kwargs):
        return await self._ensure_live_transfer().listen_download(*args, **kwargs)
    ...
    async def listen_forward(self, *args, **kwargs):
        return await self._ensure_live_transfer().listen_forward(*args, **kwargs)
