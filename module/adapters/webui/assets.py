...
<div class="view" id="view-statistics">
  <div class="stats-kpi-grid">
    <div class="stat-card">
      <div class="stat-card-icon blue">
        <svg viewBox="0 0 24 24" fill="none"><path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>
      </div>
      <div>
        <div class="stat-card-value" id="stats-kpi-links">0</div>
        <div class="stat-card-label" data-i18n="statistics.kpiLinks">监控链接</div>
      </div>
    </div>
    <div class="stat-card">
      <div class="stat-card-icon green">
      ...
      <div>
        ...
        <div class="stat-card-label" data-i18n="statistics.kpiDownloads">下载总量</div>
      </div>
    </div>
    <div class="stat-card">
      <div class="stat-card-icon orange">
    ...
    <div class="stat-card">
      ...
      <div>
        <div class="stat-card-value" id="stats-kpi-uploads">0</div>
        <div class="stat-card-label" data-i18n="statistics.kpiUploads">上传任务</div>
      </div>
    </div>
  </div>
  ...
  <div class="stats-chart-grid">
    <div class="panel">
      <div class="panel-header">
        ...
        <span class="text-xs text-muted" data-i18n="statistics.mediaChartMeta">按类型 · 成功 / 失败 / 跳过</span>
      </div>
      <div class="panel-body">
        <div id="stats-media-chart" class="stats-bar-chart"></div>
    ...
    <div class="panel">
      <div class="panel-header">
        <h3 data-i18n="statistics.linkChartTitle">链接完成率</h3>
        <span class="text-xs text-muted" data-i18n="statistics.linkChartMeta">按来源链接</span>
      </div>
      <div class="panel-body">
        <div id="stats-link-donut" class="stats-donut-wrap"></div>
      </div>
    </div>
  </div>
  ...
  <div class="panel">
    <div class="panel-header">
      <div class="panel-tabs" id="statistics-tabs">
        <button type="button" class="panel-tab active" data-stats-tab="link" data-i18n="statistics.tabLink">链接统计</button>
        <button type="button" class="panel-tab" data-stats-tab="count" data-i18n="statistics.tabCount">计数统计</button>
        <button type="button" class="panel-tab" data-stats-tab="upload" data-i18n="statistics.tabUpload">上传统计</button>
      </div>
      <button class="btn btn-sm btn-primary" id="statistics-export-btn" data-export="link">
        <svg viewBox="0 0 24 24" fill="none" width="16" height="16"><path d="M12 16V4M7 9l5-5 5 5M5 20h14" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
        <span id="statistics-export-label" data-i18n="statistics.exportCurrent">导出当前报表</span>
      </button>
    </div>
    <div class="overflow-auto">
...
const i18n = {
  zh: {
    ...
    'statistics.mediaChartMeta': '按类型 · 成功 / 失败 / 跳过',
  ...
  en: {
    ...
    'statistics.kpiDownloads': 'Total downloads',
    ...
    'statistics.mediaChartMeta': 'By type · success / failure / skip',
