      ...
      <table class="data-table">
        <thead>
          <tr>
            ...
            <th class="watch-col-actions">操作</th>
          </tr>
        </thead>
...
<!-- Watch Download Records Overlay -->
<div class="watch-overlay" id="watch-download-overlay">
  <div class="watch-dialog watch-history-dialog">
    <div class="watch-history-header">
      <h3 class="text-base font-semibold flex items-center gap-2">
        <svg viewBox="0 0 24 24" fill="none" width="18" height="18"><path d="M12 3v12m0 0l-4-4m4 4l4-4M5 19h14" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
        <span data-i18n="watches.downloadRecordsTitle">监听下载记录</span>
      </h3>
      <button type="button" class="btn btn-sm btn-icon" onclick="closeWatchDownloadModal()">✕</button>
    </div>
    <div class="watch-history-body" id="watch-download-body"></div>
  </div>
</div>
