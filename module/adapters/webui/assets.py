      ...
      <table class="data-table">
        <thead>
          <tr>
            ...
            <th class="w-[7.5rem]" data-i18n="watches.source">来源频道</th>
            <th class="w-[7.5rem]" data-i18n="watches.target">目标频道</th>
            <th>状态</th>
            <th class="w-20" data-i18n="watches.todayEvents">今日记录</th>
            <th class="min-w-[16rem]">操作</th>
          </tr>
        </thead>
