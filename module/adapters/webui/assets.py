...
<div class="sidebar">
  <div class="sidebar-brand">
    ...
    <div>
      ...
      <span class="text-base text-muted font-medium" data-i18n="app.subtitle">转存控制台</span>
    </div>
  </div>
  ...
  <div class="sidebar-nav-section">
    ...
    <div class="mt-[18px] px-[3px]">
      <div class="flex items-center justify-between text-base text-muted py-0.5">
...
<main class="main-content">
  ...
  <div id="login-container" class="login-page login-overlay hidden">
    <div class="login-brand">
      ...
      <h1>TRMD</h1>
      <p class="text-base text-muted mt-1">Telegram 账号登录</p>
    </div>
    <div class="login-card">
      <div class="login-error" id="login-error"></div>
      <div id="login-form-phone" class="login-step">
        <div class="text-base text-muted uppercase tracking-[0.06em] mb-2">步骤 1 / 3</div>
        <h2 class="text-xl font-bold m-0 mb-1.5 text-text">输入电话号码</h2>
        <p class="text-base text-muted m-0 mb-5">请输入您的 Telegram 账号绑定的手机号</p>
        <div class="login-field">
          <label for="login-phone">电话号码</label>
          <input id="login-phone" type="tel" placeholder="+8615000000000" autocomplete="tel">
          <div class="text-base text-muted mt-1">需以「+地区号」开头，如中国 +86</div>
        </div>
      ...
      <div id="login-form-code" class="login-step hidden">
        <div class="text-base text-muted uppercase tracking-[0.06em] mb-2">步骤 2 / 3</div>
        <h2 class="text-xl font-bold m-0 mb-1.5 text-text">输入验证码</h2>
        <p class="text-base text-muted m-0 mb-5" id="login-code-desc">验证码已发送到您的设备</p>
        <div class="login-field">
      ...
      <div id="login-form-password" class="login-step hidden">
        <div class="text-base text-muted uppercase tracking-[0.06em] mb-2">步骤 2.5 / 3</div>
        <h2 class="text-xl font-bold m-0 mb-1.5 text-text">两步验证密码</h2>
        <p class="text-base text-muted m-0 mb-5" id="login-password-hint">该账号已设置两步验证</p>
        <div class="login-field">
          <label for="login-password">密码</label>
          <input id="login-password" type="password" placeholder="输入两步验证密码" autocomplete="current-password">
          <div class="text-base text-muted mt-1" id="login-password-hint-text"></div>
        </div>
        <div class="flex gap-2.5 justify-end">
      ...
      <div id="login-form-recovery" class="login-step hidden">
        <div class="text-base text-muted uppercase tracking-[0.06em] mb-2">密码恢复</div>
        <h2 class="text-xl font-bold m-0 mb-1.5 text-text">输入恢复代码</h2>
        <p class="text-base text-muted m-0 mb-5" id="login-recovery-desc">恢复代码已发送</p>
        <div class="login-field">
      ...
      <div id="login-form-signup" class="login-step hidden">
        <div class="text-base text-muted uppercase tracking-[0.06em] mb-2">注册信息</div>
        <h2 class="text-xl font-bold m-0 mb-1.5 text-text">完善个人信息</h2>
        <p class="text-base text-muted m-0 mb-5">首次登录，请输入您的名字</p>
        <div class="login-field">
...
<div class="view active" id="view-transfers">
  ...
  <div class="grid grid-cols-[380px_1fr] gap-4">
    ...
    <div class="panel">
      ...
      <div class="panel-body">
        <form id="transfer-form">
          ...
          <label class="flex items-center gap-2 text-base text-muted cursor-pointer mb-3">
            <input type="checkbox" name="include_comment" class="w-4 h-4">
            <span data-i18n="new.includeComment">包含评论区</span>
          </label>
          <p class="text-base text-muted leading-[1.5] mb-2" data-i18n="new.hint">
            单条消息链接可留空。频道不填 ID 会自动探测可访问范围。
          </p>
          <div id="transfer-notice" class="text-sm mt-2 hidden"></div>
    ...
    <div class="panel">
      <div class="panel-header">
        ...
        <span class="text-base text-muted" id="last-sync" data-i18n="tasks.notSynced">尚未同步</span>
      </div>
      <div class="overflow-auto flex-1">
        ...
        <div id="tasks-empty" class="p-8 text-center text-muted text-base" data-i18n="tasks.empty">还没有转存任务。</div>
      </div>
    </div>
  </div>
  ...
  <div class="panel" id="task-detail">
    <div class="p-8 text-center text-muted text-base" data-i18n="items.selectTask">选择一个任务查看详情</div>
  </div>
</div>
...
<div class="view" id="view-watches">
      ...
      <div class="panel-header">
        <div class="flex items-center gap-2.5">
          ...
          <div>
            ...
            <span class="text-base text-muted" data-i18n="watches.downloadMeta">新消息自动下载</span>
          </div>
        </div>
      </div>
      <div class="panel-body">
      ...
      <div class="panel-header">
        <div class="flex items-center gap-2.5">
          ...
          <div>
            ...
            <span class="text-base text-muted" data-i18n="watches.forwardMeta">新消息自动转发</span>
          </div>
        </div>
      </div>
      <div class="panel-body">
  ...
  <div class="panel">
    ...
    <div class="overflow-auto">
      ...
      <div id="watches-empty" class="p-8 text-center text-muted text-base" data-i18n="watches.empty">还没有实时监听。</div>
    </div>
  </div>
</div>
...
<div class="view" id="view-downloads-uploads">
      ...
      <div class="panel-header">
        <div class="flex items-center gap-2.5">
          ...
          <div>
            ...
            <span class="text-base text-muted" data-i18n="dl.meta">从 Telegram 频道拉取文件</span>
          </div>
        </div>
      </div>
      <div class="panel-body">
      ...
      <div class="panel-header">
        <div class="flex items-center gap-2.5">
          ...
          <div>
            ...
            <span class="text-base text-muted" data-i18n="dl.uploadMeta">推送到 Telegram 频道</span>
          </div>
        </div>
      </div>
      <div class="panel-body">
  ...
  <div class="panel">
    ...
    <div class="overflow-auto">
      ...
      <div id="dl-operations-empty" class="p-8 text-center text-muted text-base" data-i18n="dl.historyEmpty">还没有下载或上传操作记录。</div>
    </div>
  </div>
</div>
...
<div class="view" id="view-records">
  <div class="panel">
    ...
    <div class="overflow-auto">
      ...
      <div id="records-empty" class="p-8 text-center text-muted text-base" data-i18n="records.empty">还没有下载成功记录。</div>
    </div>
  </div>
</div>
...
<div class="view" id="view-settings">
  <div class="panel">
    <div class="panel-header">
      ...
      <span class="text-base text-muted" data-i18n="settings.safeNote">敏感字段只显示是否已配置</span>
    </div>
    <div class="panel-body max-w-[900px]" id="settings-body">
      ...
      <div class="border border-line rounded-lg p-4 mb-[14px]">
        ...
        <div class="form-row">
          <label class="flex items-center gap-2 text-base text-text cursor-pointer">
      ...
      <div class="border border-line rounded-lg p-4 mb-[14px]">
        ...
        <label class="flex items-center gap-2 text-base text-text cursor-pointer mb-3">
      ...
      <div class="border border-line rounded-lg p-4 mb-[14px]">
        ...
        <span class="text-base text-muted" data-i18n="settings.downloadTypesHint">（勾选 = 允许下载，未勾选的类型将被忽略）</span>
      ...
      <div class="border border-line rounded-lg p-4 mb-[14px]">
        ...
        <span class="text-base text-muted" data-i18n="settings.forwardTypesHint">（勾选 = 允许转发，未勾选的类型将被忽略）</span>
      ...
      <div class="border border-line rounded-lg p-4 mb-[14px]">
        ...
        <div class="mb-3">
          ...
          <span class="text-base text-muted ml-1" data-i18n="settings.mediaTypesHint">（勾选 = 允许处理，未勾选的类型将被过滤）</span>
          <div class="grid grid-cols-2 gap-2 mt-1" id="filter-media-grid"></div>
        </div>
        <div class="mb-3">
          <label class="flex items-center gap-2 text-base text-text cursor-pointer mb-2">
      ...
      <div class="flex items-center justify-between gap-3 sticky bottom-0 bg-white py-3 border-t border-line mt-2">
        <div id="settings-notice" class="text-sm hidden"></div>
