...
<body class="min-h-screen flex items-center justify-center p-6 bg-bg text-text font-[family-name:var(--font-body)] text-[14px] max-sm:items-start max-sm:pt-[12vh] max-sm:p-5">
