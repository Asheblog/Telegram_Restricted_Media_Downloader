...
const i18n = {
  zh: {
    ...
    'systemLogs.actions': '操作',
    'systemLogs.retryArchive': '重试归档',
    'systemLogs.retrySuccess': '归档重试成功。',
    'systemLogs.retryFailed': '归档重试失败。',
    'systemLogs.retryInProgress': '该归档正在重试中。',
    'systemLogs.trace': '链路',
    'systemLogs.watch': '监听',
  ...
  en: {
    ...
    'systemLogs.retryArchive': 'Retry archive',
    'systemLogs.retrySuccess': 'Archive retry succeeded.',
    'systemLogs.retryFailed': 'Archive retry failed.',
    'systemLogs.retryInProgress': 'Archive retry is already in progress.',
