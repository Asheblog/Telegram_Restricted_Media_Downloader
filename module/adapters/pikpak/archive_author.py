...
from module.domain.archive_author.reorganize import (
    AuthorHint,
...
from module.domain.archive_naming.author_hashtags import (
    extract_hashtags_from_text,
    match_author_from_hashtags,
)
from module.adapters.pikpak.archive import (
...
class ArchiveAuthorReorganizeService:
    ...
    def _hashtags_from_message_body(cls, message) -> list[str]:
        ...
        from module.domain.archive_naming.author_hashtags import normalize_author_label
